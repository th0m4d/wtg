function create_dict_for_genre(folderName, genre_dict_size, num_iterations, target_sparcity, feature_extraction_method, random, varargin)
...
%   Detailed explanation goes here
    ...
    % missing.
    [ D, A ] = train_dictionary_ksvdbox(genre_dict_size,feature, size(feature,2)/100, target_sparcity, num_iterations, random, varargin);
